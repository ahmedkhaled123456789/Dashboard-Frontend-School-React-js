        ...
        <ul className="pt-5 p-4">
          <li className="flex items-center gap-x-2 my-4 p-2 hover:bg-[#1c30b5] rounded-md cursor-pointer">
            <i className="text-white">
              <IoMdTimer className={`${open ? "size-6 " : "size-7"}`} />
            </i>
          ...
          <li className="flex items-center justify-between my-4 p-2 hover:bg-[#1c30b5] rounded-md cursor-pointer relative">
            <div className="flex items-center gap-x-2 duration-300">
              ...
              <span
                className={`text-gray-300 text-lg ele_hide ${open ? "" : "scale-0"}`}
              >
                Students
              </span>
            </div>
            ...
            {openDropdown1 && (
              <div className="z-10 absolute top-full left-0 w-44 bg-[#17226d] shadow-md mt-1 rounded-md">
                <ul className="dropdown">
                  <Link to='/student'><li className="flex gap-x-2 items-center p-2 hover:bg-[#202f8f] cursor-pointer text-white">
                    <IoIosArrowForward className="text-white" /> All Students
                  </li></Link>
                  
                  <Link to='/addstudent'><li className="flex gap-x-2 items-center p-2 hover:bg-[#202f8f] cursor-pointer text-white">
          ...
          <li className="flex items-center gap-x-2 my-4 p-2 hover:bg-[#1c30b5] rounded-md cursor-pointer">
            <i className="text-white">
              <HiUsers className={`${open ? "size-6 " : "size-7"}`} />
            </i>
            <Link to='/parent'  className={` ${open ? "" : "scale-0"}`}> <span className={`text-gray-300 ele_hide text-lg ${open ? "" : "scale-0"}`}>
              Parents
            </span></Link>
          ...
          <li className="flex items-center justify-between my-4 p-2 hover:bg-[#1c30b5] rounded-md cursor-pointer relative">
            <div className="flex items-center gap-x-2 duration-300">
              <i className="text-white">
                <GiTeacher className={`${open ? "size-6" : "size-7"}`} />
              </i>
            ...
            {openDropdown3 && (
              <div className="z-10 absolute top-full left-0 w-44 bg-[#17226d] shadow-md mt-1 rounded-md">
                ...
                <li className="flex gap-x-2 items-center p-2 hover:bg-[#202f8f] cursor-pointer text-white">
                  ...
                  <Link to='/addexpenses'> <li className="flex gap-x-2 items-center p-2 hover:bg-[#202f8f] cursor-pointer text-white">
          ...
          <li className="flex items-center gap-x-2 my-4 p-2 hover:bg-[#1c30b5] rounded-md cursor-pointer">
            <i className="text-white">
              <SlBookOpen className={`${open ? "size-6 " : "size-7"}`} />
            </i>
            <Link to='/subject' className={` ${open ? "" : "scale-0"}`}><span className={`text-gray-300 ele_hide text-lg ${open ? "" : "scale-0"}`}>
              Subject
            </span></Link>
          ...
          <li className="flex items-center gap-x-2 my-4 p-2 hover:bg-[#1c30b5] rounded-md cursor-pointer">
            <i className="text-white">
              <IoMdSettings className={`${open ? "size-6 " : "size-7"}`} />
            </i>
            <Link to='/setting' className={` ${open ? "" : "scale-0"}`}>
            <span className={`text-gray-300 text-lg ele_hide ${open ? "" : "scale-0"}`}>
              Setting
            </span>
            </Link>
